 ...
 */
package com.vestaChrono.ecommerce.event;
...
public class UserCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserCreatedEvent\",\"namespace\":\"com.vestaChrono.ecommerce.event\",\"fields\":[{\"name\":\"id\",\"type\":\"long\",\"default\":0},{\"name\":\"name\",\"type\":\"string\",\"default\":\"\"},{\"name\":\"email\",\"type\":\"string\",\"default\":\"\"}]}");
   ...
   */
  public static com.vestaChrono.ecommerce.event.UserCreatedEvent.Builder newBuilder() {
    return new com.vestaChrono.ecommerce.event.UserCreatedEvent.Builder();
  }
   ...
   * @return A new UserCreatedEvent RecordBuilder
   */
  public static com.vestaChrono.ecommerce.event.UserCreatedEvent.Builder newBuilder(com.vestaChrono.ecommerce.event.UserCreatedEvent.Builder other) {
    return new com.vestaChrono.ecommerce.event.UserCreatedEvent.Builder(other);
  }
   ...
   * @return A new UserCreatedEvent RecordBuilder
   */
  public static com.vestaChrono.ecommerce.event.UserCreatedEvent.Builder newBuilder(com.vestaChrono.ecommerce.event.UserCreatedEvent other) {
    return new com.vestaChrono.ecommerce.event.UserCreatedEvent.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.vestaChrono.ecommerce.event.UserCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.vestaChrono.ecommerce.event.UserCreatedEvent other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.vestaChrono.ecommerce.event.UserCreatedEvent.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.vestaChrono.ecommerce.event.UserCreatedEvent.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.vestaChrono.ecommerce.event.UserCreatedEvent.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.vestaChrono.ecommerce.event.UserCreatedEvent.Builder clearEmail() {
      email = null;
